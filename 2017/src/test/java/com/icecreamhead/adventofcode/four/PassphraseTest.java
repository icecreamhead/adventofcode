...
public class PassphraseTest extends TestCase {
  ...
  private final Passphrase passphrase = new Passphrase();

  public void testPart1Test1() throws Exception {
    assertThat(passphrase.noDuplicates("aa bb cc dd ee")).isTrue();
  }

  public void testPart1Test2() throws Exception {
    assertThat(passphrase.noDuplicates("aa bb cc dd aa")).isFalse();
  }

  public void testPart1Test3() throws Exception {
    assertThat(passphrase.noDuplicates("aa bb cc dd aaa")).isTrue();
  }

  public void testPart1() throws Exception {
    String phrases = "aa bb cc dd ee\naa bb cc dd aa\naa bb cc dd aaa";
    assertThat(passphrase.countValidPart1(phrases)).isEqualTo(2);
  }

  public void testPart1Solution() throws Exception {
    System.out.println("Q4P1: " + passphrase.countValidPart1(PUZZLE_INPUT));
  }

  public void testSortWord() throws Exception {
    assertThat(passphrase.sortWord("bcad")).isEqualTo("abcd");
  }

  public void testPart2() throws Exception {
    assertThat(passphrase.countValidPart2("abcde fghij\nabcde xyz ecdab\na ab abc abd abf abj\niiii oiii ooii oooi oooo\noiii ioii iioi iiio")).isEqualTo(3);
  }

  public void testPart2Solution() throws Exception {
    System.out.println("Q4P2: " + passphrase.countValidPart2(PUZZLE_INPUT));
  }
